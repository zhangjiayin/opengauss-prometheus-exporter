...
FROM pg_stat_bgwriter`,
	...
	pgActiveSlowsql = &QueryInstance{
		...
		Metrics: []*Column{
			{Name: "datname", Usage: LABEL, Desc: "Name of database"},
			{Name: "usename", Usage: LABEL, Desc: "Name of user"},
			{Name: "client_addr", Usage: LABEL, Desc: "Client address"},
			{Name: "pid", Usage: LABEL, Desc: "Client Pid"},
			{Name: "query_start", Usage: LABEL, Desc: "Query start time"},
			{Name: "query_runtime", Usage: GAUGE, Desc: "Query running time"},
			{Name: "xact_start", Usage: LABEL, Desc: "Start time of transaction"},
			{Name: "xact_runtime", Usage: LABEL, Desc: "transaction running time"},
			{Name: "state", Usage: LABEL, Desc: "Query state"},
			{Name: "query", Usage: LABEL, Desc: "Query sql", CheckUTF8: true},
		},
		Status:  "enable",
		TTL:     -1,
		Timeout: 1,
